...
const Navbar = () => {
  return (
    <div>
      <div className="navbar shadow-sm px-4 md:px-10">
        <div className="navbar-start">
          <div className="dropdown">
            <div
              tabIndex={0}
              role="button"
              className="px-0 pr-2 md:px-4 btn btn-ghost lg:hidden"
            >
              <svg
        ...
        <div className="navbar-end flex gap-5">
          <div>
            ...
            <a target="_blank" href="https://github.com/hellojibon4">
              <button className="cursor-pointer flex items-center gap-2 md:gap-3 px-2 md:px-4 py-1 md:py-2 rounded-md bg-gradient-to-br from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-colors">
                ...
                <span className="text-white font-semibold text-sm md:text-md">
                  Contribute
                </span>
              </button>
            </a>
